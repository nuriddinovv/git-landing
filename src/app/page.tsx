        ...
        <div className="relative overflow-hidden selection:bg-[#1BADAC] selection:text-white font-[family-name:var(--font-plus-jakarta-sans)]">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 glass shadow-sm">
                <div className="max-w-7xl mx-auto px-4 h-16 md:h-20 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-2xl font-extrabold tracking-tighter text-near-black">GUDS</span>
                    </div>

                    <div className="hidden lg:flex items-center gap-6">
                        {navLinks.map(link => (
                            <a key={link.href} href={link.href} className="text-sm font-semibold text-secondary hover:text-teal-accent transition-colors">
                                {link.label}
                            </a>
                        ))}
                    </div>
                ...
                <div className="glass rounded-[32px] p-8 md:p-12 shadow-2xl flex flex-wrap items-center justify-center gap-8 md:gap-16">
                    {t.trust.map((item, idx) => (
                        <div key={idx} className="flex items-center gap-3">
                            <div className={`w-3 h-3 rounded-full ${idx % 2 === 0 ? 'bg-teal-accent' : 'bg-orange-accent'}`}></div>
                            <span className="font-extrabold text-near-black tracking-wide text-xs md:text-sm uppercase">{item}</span>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <section id="workers" className="py-24 px-4 scroll-mt-20">
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10">
                    <div className="glass p-10 md:p-14 rounded-[40px] shadow-xl border-t-4 border-teal-accent">
                        <h2 className="text-3xl font-extrabold text-near-black mb-8">{t.benefits.workers.title}</h2>
                            ...
                            {t.benefits.workers.items.map((item, i) => (
                                <li key={i} className="flex items-start gap-4">
                                    <div className="w-6 h-6 bg-teal-accent/10 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                                        <svg className="w-3.5 h-3.5 text-teal-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={4}>
                    ...
                    <div id="employers" className="glass p-10 md:p-14 rounded-[40px] shadow-xl border-t-4 border-orange-accent scroll-mt-20">
                        <h2 className="text-3xl font-extrabold text-near-black mb-8">{t.benefits.employers.title}</h2>
                        <ul className="space-y-6">
                            {t.benefits.employers.items.map((item, i) => (
                                <li key={i} className="flex items-start gap-4">
                                    <div className="w-6 h-6 bg-orange-accent/10 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                                        <svg className="w-3.5 h-3.5 text-orange-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={4}>
                                            <path d="M5 13l4 4L19 7" />
                                        </svg>
                                    </div>
                                    <p className="text-secondary font-semibold text-lg">{item}</p>
            ...
            <section id="how" className="py-24 px-4 bg-white/10 scroll-mt-20">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-4xl md:text-5xl font-extrabold text-near-black text-center mb-20">{t.howItWorks.title}</h2>
                    <div className="grid md:grid-cols-3 gap-8 md:gap-12">
                        {t.howItWorks.steps.map((step, idx) => (
                            <div key={idx} className="relative group">
                                {idx < 2 && <div className="hidden md:block absolute top-12 left-full w-full h-[2px] bg-black/5 -translate-x-1/2"></div>}
                                <div className="glass p-10 rounded-[32px] text-center relative z-10 transition-transform group-hover:-translate-y-2 h-full">
                                    ...
                                    <h3 className="text-xl font-bold text-near-black mb-4">{step.t}</h3>
            ...
            <section className="py-24 px-4 bg-black/5">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="text-center p-8 bg-teal-accent/10 rounded-[32px]">
                        <p className="text-secondary font-bold italic text-lg">“{t.gtm.keywords}”</p>
                    </div>
                </div>
            </section>
            ...
            <section id="pricing" className="py-24 px-4 scroll-mt-20">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-extrabold text-near-black mb-6">{t.pricing.title}</h2>
            ...
            <section id="faq" className="py-24 px-4 bg-white/20 scroll-mt-20">
                <div className="max-w-3xl mx-auto">
                    <h2 className="text-4xl font-extrabold text-near-black text-center mb-16">{t.faq.title}</h2>
                    ...
                    <div className="grid md:grid-cols-4 gap-12 mb-20">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 text-secondary font-semibold">
                                <li><a href="#workers" className="hover:text-teal-accent transition-colors">{t.nav.workers}</a></li>
                                <li><a href="#employers" className="hover:text-teal-accent transition-colors">{t.nav.employers}</a></li>
                                <li><a href="#how" className="hover:text-teal-accent transition-colors">{t.nav.how}</a></li>
                                <li><a href="#pricing" className="hover:text-teal-accent transition-colors">{t.nav.pricing}</a></li>
                            </ul>
                        </div>
                        <div>
                            <h4 className="font-bold text-lg mb-8 text-near-black">LEGAL</h4>
                            <ul className="space-y-4 text-secondary font-semibold">
                                {t.footer.legal.map(l => <li key={l}><a href="#" className="hover:text-teal-accent transition-colors">{l}</a></li>)}
                                <li><a href="#faq" className="hover:text-teal-accent transition-colors">{t.nav.faq}</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="relative glass bg-white w-full max-w-md rounded-[40px] p-8 md:p-12 shadow-2xl animate-fade-in-up">
                        <button onClick={() => setIsModalOpen(false)} className="absolute top-8 right-8 text-secondary hover:text-near-black">
                        ...
                        {waitlistStatus === 'success' ? (
                            <div className="text-center py-10">
                                <div className="w-20 h-20 bg-green-100 text-green-600 rounded-full flex items-center justify-center mx-auto mb-8">
                                    <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={4}><path d="M5 13l4 4L19 7" /></svg>
                                </div>
                                <h3 className="text-2xl font-black text-near-black mb-2">{t.waitlist.success}</h3>
                            </div>
                        ) : (
                            <>
                                <h3 className="text-3xl font-black text-near-black mb-10">{t.waitlist.title}</h3>
                                <form onSubmit={handleWaitlistSubmit} className="space-y-6">
                                    <div>
                                        <label className="block text-[10px] font-black text-secondary tracking-widest uppercase mb-2">{t.waitlist.name}</label>
                                        <input required className="w-full bg-black/5 border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-teal-accent/50 font-bold text-near-black" placeholder="John Doe" />
                                    </div>
                                    <div>
                                        <label className="block text-[10px] font-black text-secondary tracking-widest uppercase mb-2">{t.waitlist.contact}</label>
                                        <input required className="w-full bg-black/5 border-none rounded-2xl px-6 py-4 focus:ring-2 focus:ring-teal-accent/50 font-bold text-near-black" placeholder="name@email.com" />
                                    </div>
                                    <div>
                                        <label className="block text-[10px] font-black text-secondary tracking-widest uppercase mb-3">{t.waitlist.role}</label>
                                        <div className="grid grid-cols-2 gap-4">
                                            <label className="cursor-pointer relative group">
                                                <input type="radio" name="role" className="peer hidden" defaultChecked />
                                    ...
                                    <button type="submit" className="w-full bg-near-black text-white py-5 rounded-2xl font-black text-lg shadow-xl shadow-black/20 hover:scale-[1.02] active:scale-95 transition-all">
                                        {t.waitlist.submit}
                                    </button>
                                </form>
                            </>
